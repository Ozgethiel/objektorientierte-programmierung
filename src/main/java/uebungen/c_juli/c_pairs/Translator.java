...
public class Translator {
    ...
    public static void main(String[] args) {
        ...
        //   6. Die Klasse Map enthält ein Array vom Typ Pair.
        //      Jedes Pair in dem Array besitzt einen key vom Typ K
        //      und einen value vom Typ V.
        //   7. Die Klasse Map wird mit einem Konstruktor mit einem
        //      int-Parameter erstellt, der angibt, wie groß das Array
        //      von Pairs sein soll.
        //   8. Außerdem hat die Klasse Map eine Methode put, die einen
        //      Wert K und einen Wert V entgegennimmt. Die Methode erzeugt
        //      ein Pair von diesen beiden Werten und fügt es in das Array
        //      hinzu. Die Methode put hat keinen Rückgabetyp (void).
        //   9. Desweiteren hat die Klasse Map eine Methode get, die
        //      einen Parameter vom Typ K entgegennimmt. Sie sucht das
        //      Pair mit dem gleichen key aus ihrem Array und gibt den
        //      entsprechenden Value zurück.
        //  10. Erstellt in dieser Main Klasse eine Map germanNumbers,
        //      die 10 Pairs mit dem Key-Typ Integer und Value-Typ String
        //      fassen kann.
        ...
        //      ...
        //      9 - "Neun"
        //  12. Schreibt in dieser Klasse Pairs eine static Methode
        //      translate mit 2 Typ-Parametern, K und V. Die die einen
        //      Parameter vom Typ K-Array und einen Parameter vom Typ
        //      Map mit dem Key-Typ K und Value-Typ V annimmt und ein
        //      Array vom Typ V zurückgibt. Die Methode übersetzt jeden
        //      Key in dem Array in den entsprechenden Value, die in
        //      dem Map-Parameter angegeben ist.
        ...
        //      Also aus einem int-Array
        //      {2,8,2,0,7}
        //      wird das String-Array
        //      {"Zwei", "Acht", "Zwei", "Null", "Sieben"}
        //      Gebt das Array auf der Konsole aus.
        ...
        //      Also aus einem String-Array
        //      {"Zwei", "Acht", "Zwei", "Null", "Sieben"}
        //      wird wieder das int-Array
        //      {2,8,2,0,7}
